...
const PreviousTreks = () => {
  ...
  useEffect(() => {
    ...
    fetch("/api/treks/previous", { signal: controller.signal })
      .then((res) => res.json())
      .then((data) => {
        setTreks(data?.data || []);
      })
        ...
        <div className="w-full max-w-[1152px]">
          ...
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-sm md:text-base text-gray-500 mt-2">
              Here are the adventures you've already completed.
            </p>
          </div>
