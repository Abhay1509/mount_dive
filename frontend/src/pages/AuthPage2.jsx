      ...
      >
        ...
        <div className="m-0 p-0 absolute top-6 flex items-center mb-5">
          <img
            ...
            alt="Mount Dive"
            className="w-[71px] h-[42px] top-[5px] mb-2"
          />
        ...
        <div className="flex justify-center mb-3 z-40">
          <div className="bg-[#4D4D4D] w-[352px] h-[45px] rounded-[30px] p-1 flex justify-items-center items-center absolute top-[95px]">
            <button
              aria-pressed={contactMethod === "email"}
              onClick={() => handleToggle("email")}
              className={`px-5 ml-1 my-3 w-1/2 font-semibold h-full font-syne py-1 text-white rounded-full transition ${
                contactMethod === "email"
                  ? "bg-white text-black"
                  : "text-white"
              }`}
            ...
            <button
              ...
              className={`px-5 mr-1 w-1/2 h-full font-semibold py-1 text-white font-syne rounded-full transition ${
                contactMethod === "phone"
                  ? "bg-white text-black"
                  : "text-white"
              }`}
